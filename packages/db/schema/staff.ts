...
import { staffDepartment, staffStatus } from "./enums";
...
export const staffProfiles = pgTable(
  "staffProfiles",
  {
    ...
    department: staffDepartment("department").default("school").notNull(),
...
export const staffAssignments = pgTable(
  ...
  table => [
    unique("staff_assignment_unique").on(
      table.staffId,
      table.courseId,
      table.classId
    ),
...
export const staffAssignmentsRelations = relations(
  ...
  ({ one }) => ({
    ...
    course: one(courses, {
      fields: [staffAssignments.courseId],
