...
// Domain), so a sibling app cannot plant a matching value in a victim's
// browser. Each app (admin-dashboard, barber-client-app) keeps its own
// independent session — this is intentional, not a gap to close.
